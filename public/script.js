    ...
    function showFallbackContact() {
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 052-6662922 placeholder which businessInfoUpdater can replace
        ...
        (function disablePlaceholderLinks() {
            ...
            const socialPlaceholders = [
                ...
                'https://facebook.com/share/1FLizkTENE',
                'https://instagram.com/gurimbakfar?igsh=YnlwemJqMWU3ODBz',
                'https://instagram.com/gurimbakfar?igsh=YnlwemJqMWU3ODBz',
                'https://wa.me/972526662922',
                'https://wa.me/972526662922',
                '[social_twitter]',
                '[social_linkedin]',
                '[social_youtube]',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '30aa8b51-0129-4b18-97a7-1ceb60d56ea2';
